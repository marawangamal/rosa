...
# 4. Run your code
python train.py dataset.cache=$SLURM_TMPDIR/huggingface train.epochs=5 train.lr=5e-5 train.scheduler.name=linear train.batch_size=5 train.optimizer.name=adamw model.name=gpt2-medium fnmodel.name=none
